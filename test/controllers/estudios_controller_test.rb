...
class EstudiosControllerTest < ActionController::TestCase
  ...
  test "should create estudio" do
    assert_difference('Estudio.count') do
      post :create, estudio: { descripcion: @estudio.descripcion, empleado_id: @estudio.empleado_id, fecha: @estudio.fecha, lugar: @estudio.lugar, nombre: @estudio.nombre }
    end
  ...
  test "should update estudio" do
    patch :update, id: @estudio, estudio: { descripcion: @estudio.descripcion, empleado_id: @estudio.empleado_id, fecha: @estudio.fecha, lugar: @estudio.lugar, nombre: @estudio.nombre }
    assert_redirected_to estudio_path(assigns(:estudio))
  end
